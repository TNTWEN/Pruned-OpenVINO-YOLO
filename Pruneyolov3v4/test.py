...
def test(cfg,
    ...
    if dataloader is None:
        #+++++++++++++++++++++++++ insert +++++++++++++++++++++++++#
        if 'opt.single_cls' in dir():
            is_single_cls = opt.single_cls
        else:
            is_single_cls = single_cls

        is_training = False
        #+++++++++++++++++++++++++ insert end++++++++++++++++++++++#

        dataset = LoadImagesAndLabels(path, imgsz, batch_size, rect=True, single_cls=is_single_cls, pad=0.5)
